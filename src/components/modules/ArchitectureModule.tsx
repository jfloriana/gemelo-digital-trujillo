    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          ...
          <h3 className="font-bold text-base text-slate-900 mb-1">Capa de Activos Físicos 3D</h3>
        ...
        >
          ...
          <h3 className="font-bold text-base text-slate-900 mb-1">Capa de Datos & IoT</h3>
          <p className="text-xs text-slate-600">
        ...
        >
          ...
          <h3 className="font-bold text-base text-slate-900 mb-1">Capa de Modelado & Simulación</h3>
          <p className="text-xs text-slate-600">
      ...
      <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200/80 space-y-2">
                <h4 className="font-semibold text-sm text-slate-900">1. Geometría Urbana & BIM</h4>
              ...
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200/80 space-y-2">
                <h4 className="font-semibold text-sm text-slate-900">2. Propiedades de Superficie</h4>
                <p className="text-xs text-slate-600 leading-relaxed">
              ...
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200/80 space-y-2">
                <h4 className="font-semibold text-sm text-slate-900">3. Elementos Porosos (Vegetación)</h4>
                <p className="text-xs text-slate-600 leading-relaxed">
        ...
        {activeTier === 2 && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200/80 space-y-2">
                <h4 className="font-semibold text-sm text-slate-900">1. Hardware de Bajo Costo</h4>
                <p className="text-xs text-slate-600 leading-relaxed">
              ...
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200/80 space-y-2">
                <h4 className="font-semibold text-sm text-slate-900">2. Protocolos & Telemetría</h4>
                <p className="text-xs text-slate-600 leading-relaxed">
              ...
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200/80 space-y-2">
                <h4 className="font-semibold text-sm text-slate-900">3. Control de Calidad (QA/QC)</h4>
                <p className="text-xs text-slate-600 leading-relaxed">
        ...
        {activeTier === 3 && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200/80 space-y-2">
                <h4 className="font-semibold text-sm text-slate-900">1. Motor de Deep Learning</h4>
                <p className="text-xs text-slate-600 leading-relaxed">
              ...
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200/80 space-y-2">
                <h4 className="font-semibold text-sm text-slate-900">2. Simulación de Microclima & NbS</h4>
                <p className="text-xs text-slate-600 leading-relaxed">
              ...
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200/80 space-y-2">
                <h4 className="font-semibold text-sm text-slate-900">3. Retroalimentación Bidireccional</h4>
                <p className="text-xs text-slate-600 leading-relaxed">
      ...
      <div className="bg-white border border-slate-200/80 rounded-2xl p-6 space-y-4 shadow-sm">
          ...
          {reflectFramework.map((rf) => {
            ...
            return (
              ...
              >
                ...
                <h4 className="font-bold text-xs text-slate-900">{rf.name}</h4>
                <p className="text-[10px] text-slate-500 mt-1 line-clamp-3">{rf.description}</p>
              </button>
            );
          })}
        </div>
        ...
        <div className="bg-slate-50 p-4 rounded-xl border border-slate-200/80 flex items-center justify-between text-xs">
          ...
          <span className="text-slate-500 font-mono text-[11px]">REFLECT Layer 0{activeReflectStep}/07</span>
        </div>
      </div>
    </div>
  );
